...
func (engine Ghostscript) Merge(ctx context.Context, logger *zap.Logger, inputPaths []string, outputPath string) error {
	...
	args = append(args, "-dEmbedAllFonts=true")
	args = append(args, "-dSubsetFonts=true")
	args = append(args, "-dColorImageDownsampleType=/Bicubic")
	args = append(args, "-dColorImageResolution=144")
	args = append(args, "-dGrayImageDownsampleType=/Bicubic")
	args = append(args, "-dGrayImageResolution=144")
	args = append(args, "-dMonoImageDownsampleType=/Bicubic")
	args = append(args, "-dMonoImageResolution=144")
